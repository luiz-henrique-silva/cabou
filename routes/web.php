...
// Route::get('/api/professores', function (Request $request) {
//     $courseId = $request->query('course_id');
//     $professores = Professor::where('course_id', $courseId)->get();
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/solicitacoes/{solicitation}/aprovar', [ProjectController::class, 'approve'])->name('solicitations.approve');
...
Route::get('/professores', [ProjectController::class, 'getProfessorsByCourse'])->name('professores.byCourse');
